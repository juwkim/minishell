...
#    Updated: 2023/02/13 11:16:50 by juwkim           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS				+= $(addprefix $(SRC_DIR)/$(EXECUTOR_DIR)/, executor.c single_cmd.c group.c pipeline.c pipeline_utils.c builtin.c not_builtin.c redirection.c)
